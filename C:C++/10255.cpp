...
int main() {
    ...
    scanf("%d",&t);
    while(t--) {
        scanf("%lld %lld %lld %lld %lld %lld %lld %lld", &dec.rec.first.x, &dec.rec.first.y, &dec.rec.second.x, &dec.rec.second.y, &dec.lis.first.x, &dec.lis.first.y, &dec.lis.second.x, &dec.lis.second.y);
        ...
        cnt[tmp4]++;
        if(cnt[4] > 0) printf("4\n");
        else if(cnt[3] == 4) printf("2\n");
        else if(cnt[3] == 2 && cnt[0] == 2) printf("1\n");
        else if(cnt[3] == 2 && cnt[2] >= 1) printf("2\n");
        else if(cnt[3] == 2 && cnt[1] >= 1) printf("2\n");
        else if(cnt[2] == 2 && cnt[0] == 2) {
            if(dec.ccw(dec.r1, dec.r2, dec.lis.first) >= 0 && dec.ccw(dec.r2, dec.r4, dec.lis.first) >= 0 && dec.ccw(dec.r4, dec.r3, dec.lis.first) >= 0 && dec.ccw(dec.r3, dec.r1, dec.lis.first) >= 0 && dec.ccw(dec.r1, dec.r2, dec.lis.second) >= 0 && dec.ccw(dec.r2, dec.r4, dec.lis.second) >= 0 && dec.ccw(dec.r4, dec.r3, dec.lis.second) >= 0 && dec.ccw(dec.r3, dec.r1, dec.lis.second) >= 0) printf("2\n");
            else printf("1\n");
        }
        else if(cnt[2] > 2 || cnt[1] >= 2) printf("2\n");
        else if(cnt[2] >= 1 && cnt[1] >= 1) printf("2\n");
        else if(cnt[2] == 1 || cnt[1] == 1) printf("1\n");
        else printf("0\n");
    }
    return 0;
}